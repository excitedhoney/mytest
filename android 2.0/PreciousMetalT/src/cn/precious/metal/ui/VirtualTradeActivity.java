...
import cn.precious.metal.adapter.TradeHostoryAdapter;
import cn.precious.metal.adapter.VirtualTradeAdapter;
...
public class VirtualTradeActivity extends BaseActivity implements
	...
	class InifAssetTask extends AsyncTask<String, Void, String> {
		...
		protected void onPostExecute(String result) {
			...
			tvTotalValue.setText("" + Utils.getFloatDecimal((AppSetting.getInstance(VirtualTradeActivity.this)
							.getVirtualBalance() + openingValue)));
			tvBalance.setText(Utils.getFloatDecimal(AppSetting.getInstance(VirtualTradeActivity.this).getVirtualBalance()) + "");
