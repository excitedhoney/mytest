...
import cn.precious.metal.listener.KLineFragmentChangeListener;
import cn.precious.metal.services.OptionalService;
import cn.precious.metal.tools.ExcepUtils;
import cn.precious.metal.ui.fragment.chart.FenshiChartFragment;
import cn.precious.metal.ui.fragment.chart.KLineFragment;
...
//		op_hua.setOnClickListener(this);// 画 黄金分割线 水平线
	...
	public void handlerOritationView(boolean isOrientation) {
		if (isOrientation) {
			...
			LayoutParams params = new LayoutParams(LayoutParams.MATCH_PARENT,
					Utils.getWindowHeight(this) - Utils.dip2px(this, 48.5f));
			findViewById(R.id.frag_container).setLayoutParams(params);
	...
	public void fragmentChange(int currentTag) {
		// TODO Auto-generated method stub
		if (currentTag == 0) {
			// gline.setOnClickListener(new View.OnClickListener() {
			//
			// @Override
			// public void onClick(View v) {
			// // TODO Auto-generated method stub
	...
	private int REFRESH_DELAY = 10 * 1000;
