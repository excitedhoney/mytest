...
public class ParamSetActivity extends BaseActivity implements OnClickListener{
	...
	public void onClick(View v) {
		...
		switch (v.getId()) {
		case R.id.ll_sma:
			Intent itSma = new  Intent(ParamSetActivity.this, KlineNormSetActiviy.class) ;
			itSma.putExtra("norm", "sma") ;
			startActivity(itSma);
			break;
		case R.id.ll_ema:
			Intent itEma = new  Intent(ParamSetActivity.this, KlineNormSetActiviy.class) ;
			itEma.putExtra("norm", "ema") ;
			startActivity(itEma);
			break;
		case R.id.ll_bool:
			Intent itBool = new  Intent(ParamSetActivity.this, KlineNormSetActiviy.class) ;
			itBool.putExtra("norm", "bool") ;
			startActivity(itBool);
			break;
		case R.id.ll_macd:
			Intent itMacd = new  Intent(ParamSetActivity.this, KlineNormSetActiviy.class) ;
			itMacd.putExtra("norm", "macd") ;
			startActivity(itMacd);
			break;
		case R.id.ll_kdi:
			Intent itKdi = new  Intent(ParamSetActivity.this, KlineNormSetActiviy.class) ;
			itKdi.putExtra("norm", "kdj") ;
			startActivity(itKdi);
			break;
		case R.id.ll_rsi:
			Intent itRsi = new  Intent(ParamSetActivity.this, KlineNormSetActiviy.class) ;
