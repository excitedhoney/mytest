package com.xiyou.apps.lookpan.ui.fragment.chart;
...
public class FenshiChartFragment extends BaseFragment {
	...
	public static FenshiChartFragment newInstance(String treaty, String type,
			String interval) {
		...
		mActivity.findViewById(R.id.iv_norm).setOnClickListener(
				new View.OnClickListener() {
					...
					public void onClick(View v) {
						// TODO Auto-generated method stub
						Toast.makeText(getActivity(), "分时线不可用该功能,请切换到其他周期K线",
								1000).show();
					}
				});
	...
	class GetKlineDataTask extends AsyncTask<String, Void, String> {
		...
		protected String doInBackground(String... params) {
			...
			try {
				kLineEntities = service.getKlineByinterval(params[0],
						params[1], params[2]);
