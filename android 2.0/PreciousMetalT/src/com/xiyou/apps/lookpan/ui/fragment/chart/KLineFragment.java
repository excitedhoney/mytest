...
//						unionCandleStickChart.setTop(false);
...
//				unionCandleStickChart.setTop(true);
			}
		});
...
//		});
	...
	private View.OnClickListener changeNormListener = new View.OnClickListener() {
		...
		public void onClick(View v) {
			// TODO Auto-generated method stub
//			if(PortOptionalActivity.currentTag == 0) {
//				Toast.makeText(getActivity(), "分时线不可用该功能,请切换到其他周期K线",1000).show();
//			}else{
				updateChartNorm();
//			}
		}
