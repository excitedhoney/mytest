...
package cn.precious.metal.view.event;
...
import cn.precious.metal.view.entity.OHLCEntity;
import cn.precious.metal.view.view.BaseChart;
import cn.precious.metal.view.view.MACandleStickChart;
...
public class MACandleStickChartTouchEventAssemble implements
	...
	public void notifyEvent(BaseChart chart, int index) {
		 ...
		 if (null != tvD) {
		 String date =e.getDate().substring(2);
